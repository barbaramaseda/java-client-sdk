...
public interface Compare {
     ...
     * @throws ApiException : if the cortical.io's API isn't available/ or an internal error occurred.
     */
    Metric[] compareBulk(CompareModels...compareModels) throws JsonProcessingException, ApiException;
     ...
     * @throws ApiException : if the cortical.io's API isn't available/ or an internal error occurred.
     */
    Metric[] compareBulk(String json) throws JsonProcessingException, ApiException;
}
